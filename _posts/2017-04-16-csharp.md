...
* Encoding.Unicode指的是小端UTF16；Encoding.Default在Core上是UTF8，在FX上是ANSI，Encoding.ASCII只能编码英文。控制台编码FX是DBCSCodePageEncoding，Core是OSDefault，都是找不到的，chcp设为U8后有变化
