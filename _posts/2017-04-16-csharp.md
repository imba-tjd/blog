...
* Application.Exit() 退出整个程序，返回到Main的Application.Run()的地方，会等待前台线程完成；会引发FormClosing事件
* Application.ExitThread() 终止当前线程，返回到上一层Application.Run()的地方
...
* System.Globalization.StringInfo可处理“组合字符”，LengthInTextElements的长度
