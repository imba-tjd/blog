...
* apt install golang-go; go version。但apt的版本低。若已安装低版本可用go install golang.org/dl/go1.18@latest; go1.18 download; go1.18 version
...
* rand.Seed(time.Now().Unix()) 默认会自动播种
* rand.Intn(10) 在[0,10)
