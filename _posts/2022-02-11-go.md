...
* 数组
  ...
  * 可以直接输出
  * 大小固定，用[...]时根据字面量自动设定长度
  * 是值语义，传参时会整个复制；可以直接判断相等，如果长度不等会在编译期报错
* 切片
...
* https://golang.google.cn/doc/faq 看到How can I guarantee my type satisfies an interface?
...
* https://golang.google.cn/doc/ 看到Developing modules
