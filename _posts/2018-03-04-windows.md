...
* 调整TDP(PPT)和温度限制
  * https://github.com/FlyGoat/RyzenAdj https://github.com/JamesCJ60/Universal-x86-Tuning-Utility
    * 第一项支持-i查看当前值。Wiki有一些内容
    * 第二项是第一项的GUI，需要 .NET Runtime，第一次运行会隐式执行一大堆ps脚本。也支持Intel。预设了几种模式，支持根据不同的正在运行的应用动态调整。感觉不如命令行。前身叫amdaputuningutility
  * ThrottleStop
...
* HEVC扩展：ms-windows-store://pdp/?ProductId=9N4WGH0Z6VHQ https://bbs.pcbeta.com/forum.php?mod=redirect&goto=findpost&ptid=2053927&pid=57246099
