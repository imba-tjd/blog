...
* 自定义序列化：注入RedisConnectionFactory，@Bean new RedisTemplate设置fac、key、value、hash的序列化方法，可用new Jackson2JsonRedisSerializer<>(C.class)或GenericJackson2JsonRedisSerializer，后者会多生成一个@class记录原来的类型
