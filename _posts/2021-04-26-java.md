...
* JDK
  ...
  * Liberica：https://bell-sw.com/pages/downloads/#/java-18-current 提供Lite版
...
* java [-Dfile.encoding=gbk] -cp bin Main：设定运行时编码，JDK18默认为u8，改回原行为用=COMPAT，取得代码页编码用System.getProperty("native.encoding")
