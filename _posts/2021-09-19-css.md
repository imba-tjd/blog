...
* 边框border
  ...
  * border-boundary
* 行盒
  * 不能设置宽高，只能用 字体大小、行高 间接调整
  * padding 水平方向有效，垂直(上下)方向仅影响背景，不占据空间。border类似，上下有边框但无空间。margin上下完全无效
...
* Penpot 开源的，Web版 https://penpot.app/blog/penpot-ui-design-software-a-beginners-guide/
