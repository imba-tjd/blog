...
* 取另一个控件的属性：ElementName=另一个控件的xName。取自己的属性：RelativeSource={RelativeSource Self}
...
* https://github.com/microsoft/XamlBehaviorsWpf 行为 类似于命令和附加属性的结合，容易给一个控件应用多个。还加强了触发器
