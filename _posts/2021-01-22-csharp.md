...
* 使用回调函数或返回指针时注意垃圾回收
* 调用Win32的API：https://pinvoke.net https://github.com/dotnet/pinvoke https://github.com/microsoft/CsWin32 （是前者的进化版，只用于C#） https://github.com/dahall/Vanara https://github.com/JeremyKuhne/WInterop 还有个最后更新时间2019年且无release的pinvoke-interop-assistant
* 调用UWP的API：CsWinRT
