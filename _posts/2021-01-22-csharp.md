...
* 使用回调函数或返回指针时注意垃圾回收
* 调用Win32的API：https://pinvoke.net https://github.com/dotnet/pinvoke https://github.com/microsoft/CsWin32 https://github.com/dahall/Vanara 还有个不活跃且无release的pinvoke-interop-assistant
* 调用UWP的API：CsWinRT
