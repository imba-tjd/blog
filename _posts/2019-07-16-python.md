...
* 构建了security版的：https://gregoryszorc.com/docs/python-build-standalone/main/running.html https://github.com/adang1345/PythonWindows
* VSC设置
...
* contextvars.Context：必须声明成全局变量，一次只是一个对象，在某个函数里set后，当前函数中的后序其他函数调用都能get。可以跨async和sync函数用
