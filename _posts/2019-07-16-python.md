...
first,*middle,end = (1,2,3,4) # middle即2,3
```
...
s.add、remove # 也可用+=和-=
# 可以看作数学上的集合，因此可以做交集&和并集|操作，前者相当于intersection函数
```
...
* https://www.zhihu.com/question/51467397 https://zhuanlan.zhihu.com/p/104524108
...
* https://zhuanlan.zhihu.com/p/54430650 110道Python面试题（真题）
* Airtest
* charles
