...
* Win版，非官方
  * https://github.com/redis-windows/redis-windows 依赖msys-2.0.dll，且还依赖另两个其他项目不依赖的msys dll，估计是TLS要用
    * https://github.com/hemnstill/StandaloneTools 7.2.3但用不了
  * https://github.com/CacoCode/LeadingCode.RedisPack/tree/master/attrs 目前7.2官方会报STATUS_ACCESS_VIOLATION用不了
