...
* 跨线程调用控件
  * 控件的Invoke/BeginInvoke，见 https://www.cnblogs.com/marshal-m/p/3201051.html#invoke 关键是InvokeRequired时还要处理IsHandleCreated为false的情况，此时控件尚未创建完成，需要自旋等待，太麻烦了不记录；又但是官方文档没有这样做。与委托的Invoke同名但其实不同
...
* https://github.com/N-a-r-w-i-n/MetroSet-UI 最后维护时间是2020年10月，500KB，高DPI有问题，要把AutoScaleMode调成DPI才会与设计时一样大
