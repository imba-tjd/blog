...
```
Content-Security-Policy: default-src 'none'; style-src 'unsafe-inline' # 禁止所有其它内容，允许行内style
...
* Access-Control-Expose-Headers: 客户端可以获得的服务器发出的头。默认只有几个安全头
* Access-Control-Allow-Credentials: true 允许客户端带上Cookie。此时其它几个AC不能为*
...
* https://github.com/locustio/locust Py
* https://github.com/grafana/k6 Go
* https://github.com/JoeDog/siege C
* https://github.com/apache/jmeter JAVA
* gatling Scala
* 不活跃的：tsenart/vegeta
