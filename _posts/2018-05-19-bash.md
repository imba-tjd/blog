...
* echo {1..10..2}：1 3 5 7 9，即首、尾、增量
* echo {10..1..2}：10 8 6 4 2，递减
* echo {01..10}：01 02 03 04 05 06 07 08 09 10
* echo "{1..5}"为普通的`{1..5}`字符串；a={1..5} && echo $a也是普通的字符串，可用把反引号echo {1..5}赋值给它解决
...
* 通配符：支持`?`、`*`、`[abc]`、`[a-z]`、`[^0-9]`，由shell展开，若在引号中则不展开
